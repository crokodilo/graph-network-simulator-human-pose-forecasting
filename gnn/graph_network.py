...
class InteractionNetwork(MessagePassing):
  ...
  def update(self,
    ...
    #This function takes in the output of aggregation as first argument and any argument which was initially passed to propagate()
    #x_updated = sum(messages) since we set aggregation = sum in the __init__ 
