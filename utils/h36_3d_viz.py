    ...
    for action in actions:
      ...
      # joints at same loc ----> joints at index_to_ignore are equal to joints at index_to_equal (this is my guess)
        ...
        for cnt,batch in enumerate(loader): 
            ...
            #joints at index_to_ignore are equal to joints at index_to_equal (this is my guess)
            ...
            import pickle
            with open(f'galasso/rollout_pred_{action}_out_{output_n}.pkl', 'wb') as f:
                pickle.dump(data_pred, f)

            with open(f'galasso/rollout_gt_{action}_out_{output_n}.pkl', 'wb') as f:
                pickle.dump(data_gt, f)
                
            with open(f'galasso/loss_{action}_out_{output_n}.pkl', 'wb') as f:
                pickle.dump(loss, f)
            ...
            line_anim.save('galasso/human_viz_'+str(action)+'.gif',writer='pillow')
