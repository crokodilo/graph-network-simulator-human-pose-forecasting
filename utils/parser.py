...
parser.add_argument('--n_mps',type=int,default=10,help= 'number of message passing layers')
parser.add_argument('--cradius',type=int,default=500,help= 'connectivity radius')
parser.add_argument('--nmlp_layers',type=int,default=2,help= 'number of mlp layers')
...
parser.add_argument('--mode',type=str,default='train',choices=['train','test', 'hptuning', 'render', 'viz'],help= 'Choose to train,test or visualize from the model.Either train,test or viz')
